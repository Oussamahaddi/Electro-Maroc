...
<div>
    <div class="overflow-y-scroll h-screen grid grid-cols-[auto_1fr] antialiased bg-gray-700">
        ...
        <!-- Sidebar -->
        <div class="mt-12 flex flex-col top-14 left-0 hover:w-64 md:w-64 bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.6.3/flowbite.min.js"></script>
    ...
    <script src="<?= URLROOT . '/js/delete.js'; ?>"></script>
</html>